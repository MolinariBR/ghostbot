...
try:
    ...
    print("⚠️ Alguns módulos não disponíveis, usando fallbacks")
    LightningAddressResolver = None
    binance_api = None
    coingecko_api = None
    LimitesValor = None
    ComissaoCalculator = None
    GhostBotLightningHandler = None
...
class TesteFluxoCompleto:
    ...
    def _verificar_smart_pix_monitor(self):
        ...
        try:
            from smart_pix_monitor import smart_monitor, get_monitor_stats
    ...
    def _verificar_sistema_gatilhos(self):
        ...
        try:
            ...
            return hasattr(trigger_system, 'trigger_event')
        except:
            return False
    ...
    def _verificar_handlers_bot(self):
        ...
        try:
            from integrador_bot_gatilhos import BotTriggerIntegrator
            return True
        except:
            return False
